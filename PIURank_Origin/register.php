            ...
            <div class="row">
              <div class="col-lg-7">
                <div class="p-5">
                  ...
                  <form class="user" id="pi_form" name="pi_form" method="post" action="register_action.php">
                    ...
                    <div class="g-recaptcha recap_center" style="margin:auto" data-sitekey="6LftetsUAAAAAIO_nEX8DMF10PU80bkXz2Yd0Rdx"></div>
